...
public:
	...
	CSplitter(CKMCParams &Params, CKMCQueues &Queues, const CHashModuloFilter& moduloFilter);
...
public:
	CWSplitter(CKMCParams &Params, CKMCQueues &Queues, const CHashModuloFilter& moduloFilter);
	void operator()();
...
public:
	CWStatsSplitter(CKMCParams &Params, CKMCQueues &Queues, const CHashModuloFilter& moduloFilter);
	~CWStatsSplitter();
...
public:
	CWSmallKSplitter(CKMCParams &Params, CKMCQueues &Queues, const CHashModuloFilter& moduloFilter);
	~CWSmallKSplitter();
