...
public:
	...
	struct _si  
	{
		_si()
		{
			for (int i = 0; i < 256; i++)
                num_codes[i] = -1;
			num_codes[static_cast<unsigned char>('A')] = num_codes[static_cast<unsigned char>('a')] = 0;
			num_codes[static_cast<unsigned char>('C')] = num_codes[static_cast<unsigned char>('c')] = 1;
			num_codes[static_cast<unsigned char>('G')] = num_codes[static_cast<unsigned char>('g')] = 2;
			num_codes[static_cast<unsigned char>('T')] = num_codes[static_cast<unsigned char>('t')] = 3;
        }
    } static _init;
